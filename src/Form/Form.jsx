...
<div id="contactform">
    ...
    <Form onSubmit={handleSubmitBooking} >
                ...
                <Form.Group>
                    ...
                    <Form.Select onChange={handleDetails} name='eventType' value={bookingDetails.eventType}>
                ...
                <Form.Group>
                    ...
                    <Form.Control type='number' name='guests' value={bookingDetails.guests} onChange={handleDetails} placeholder="Enter number of guests" required/>
                </Form.Group>
                <Form.Group>
